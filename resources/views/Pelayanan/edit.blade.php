    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          <div class="card-body">
          <input type="hidden" name="gambar_layanan_old" value="{{ $layanan->gambar_layanan }}">
            <h6 class="card-subtitle mb-3">
              Ubah Gambar Pelayanan Yang akan diperlihatkan kepada user.
            </h6>
            <!-- menampilkan gambar lama -->
            <img src="{{ asset('resources/assets/images/'.$layanan->gambar_layanan) }}" alt="Gambar Layanan" class="img-fluid " width="100" /> <br> <span class="mb-4">Gambar Lama</span>
