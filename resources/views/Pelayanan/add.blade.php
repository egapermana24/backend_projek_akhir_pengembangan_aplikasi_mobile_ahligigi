...
<div class="container-fluid">
  ...
  @endif
  <form action="/pelayanan-add" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          ...
          <div class="card-body p-4">
            <div class="mb-4">
              ...
              <div class="input-group border rounded-1">
                ...
                <input type="text" name='nama_layanan' class="form-control" placeholder="Type Here..." required>
              </div>
            </div>
            <div class="mb-4">
              ...
              <div class="input-group border rounded-1">
                ...
                <input type="number" name='harga' class="form-control" placeholder="Type Here..." required>
              </div>
            </div>
            <div class="mb-4">
              ...
              <div class="input-group border rounded-1">
                ...
                <input type="text" name='durasi' class="form-control border-0 ps-2" placeholder="Type Here..." required>
              </div>
            </div>
            <div class="mb-4">
              ...
              <div class="input-group border rounded-1">
                ...
                <textarea class="form-control summernote p-7 border-0 ps-2" name="deskripsi" id="" cols="20" rows="1" placeholder="Type Here..." required></textarea>
              </div>
            </div>
          </div>
        </div>
