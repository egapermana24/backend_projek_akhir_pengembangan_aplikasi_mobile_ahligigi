...
<header class="app-header">
  <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="d-block d-lg-none">
      ...
      <img src="{{ asset('resources/assets/images/logo_text.png') }}" class="light-logo" width="180" alt="" />
    </div>
            ...
            <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown" aria-expanded="false">
              <div class="d-flex align-items-center">
                <div class="user-profile-img">
                  @if($user->role == 'dokter')
                  <img src="{{ asset('resources/assets/images/' . $user->foto_user) }}" class="rounded-circle" width="35" height="35" alt="" />
                  @elseif($user->role == 'pengunjung')
                  <img src="{{ $user->foto_user }}" class="rounded-circle" width="35" height="35" alt="" />
                  @else
                  <img src="{{ asset('resources/dist/images/profile/user-1.jpg') }}" class="rounded-circle" width="35" height="35" alt="" />
                  @endif
                </div>
              </div>
            </a>
            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
              <div class="profile-dropdown position-relative" data-simplebar>
                ...
                <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                  @if($user->role == 'dokter')
                  <img src="{{ asset('resources/assets/images/' . $user->foto_user) }}" class="rounded-circle" width="80" height="80" alt="" />
                  @elseif($user->role == 'pengunjung')
                  <img src="{{ $user->foto_user }}" class="rounded-circle" width="80" height="80" alt="" />
                  @else
                  <img src="{{ asset('resources/dist/images/profile/user-1.jpg') }}" class="rounded-circle" width="80" height="80" alt="" />
                  @endif
                  <div class="ms-3">
                    <h5 class="mb-1 fs-3">{{ $user->nama_user }}</h5>
                    <span class="mb-1 d-block text-dark">{{ ucfirst($user->role) }}</span>
                ...
                <div class="message-body">
                  <a href="profil" class="py-8 px-7 mt-8 d-flex align-items-center">
                ...
                <div class="d-grid py-4 px-7 pt-8">
                  ...
                  <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-outline-primary">Log Out</a>
                </div>
              </div>
            </div>
          </li>
