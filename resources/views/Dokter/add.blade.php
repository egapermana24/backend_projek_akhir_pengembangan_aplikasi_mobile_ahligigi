...
<div class="container-fluid">
  <div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
      <div class="row align-items-center">
        <div class="col-9">
          <h4 class="fw-semibold mb-8">Tambah Data Dokter</h4>
  ...
  <form action="/dokter-add" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          ...
          <div class="card-body p-4">
            ...
            <div class="mb-4">
              ...
              <div class="input-group border rounded-1">
                <input type="number" name="pengalaman" class="form-control" placeholder="Type Here..." required>
              </div>
            </div>
            <div class="mb-4">
              <label for="deskripsi" class="form-label fw-semibold">Deskripsi</label>
              <div class="input-group border rounded-1">
                <textarea name="deskripsi" class="form-control" rows="3" placeholder="Type Here..." required></textarea>
              </div>
            </div>
          </div>
        </div>
